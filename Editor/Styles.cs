...
{
    /// <summary>
    /// Class representing the different styling used within the event channel editor scripts.
    /// </summary>
    internal static class Styles
    {
        ...
        public static readonly GUIContent RESET = new("Reset", "Reset the event channel from all event handlers.");
    }
}